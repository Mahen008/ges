...
<body>
	...
	<div class="container">
		...
		<form method="post" action="<?php echo base_url()?>Observation/AjoutObservation">
					  ...
					  <table class="table" border="solid">
					  	...
					  	<tbody>
					  		...
					  		<td>
								  ...
								  <input type="radio" name="attenteGre">
								  <span class="checkmark"></span>
								</label>
								<label class="container">NON
								  <input type="radio" checked="checked" name="attenteGre">
								  <span class="checkmark"></span>
								</label>
